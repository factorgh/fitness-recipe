...
class _RecurrenceSelectionWidgetState extends State<RecurrenceSelectionWidget> {
  ...
  void handleOccuranceChange() {
    setState(() {
      if (_selectedRecurrence == 'Custom') {
        _customDays = 1;
        _daysSelected.clear();
        _daysSelected.addAll(List.generate(7, (_) => false));
        _selectedMultipleWeekDays.clear();
      } else if (_selectedRecurrence == 'Specific Days in Multiple Weeks') {
        _selectedMultipleWeekDays.clear();
      }
    });
  }
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    print(_selectedRecurrence); // Close bottom sheet.
                  },
